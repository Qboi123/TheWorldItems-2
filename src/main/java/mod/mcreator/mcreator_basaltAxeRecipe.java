...
public class mcreator_basaltAxeRecipe extends theworlditems2.ModElement {
    @Override
    public void load(FMLInitializationEvent event) {
        ...
        GameRegistry.addShapedRecipe(new ResourceLocation("theworlditems2:basaltaxerecipe"), new ResourceLocation("custom"), recStack, recipe);
    }
}
