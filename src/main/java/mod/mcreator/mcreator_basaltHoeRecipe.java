...
public class mcreator_basaltHoeRecipe extends theworlditems2.ModElement {
    @Override
    public void load(FMLInitializationEvent event) {
        ...
        GameRegistry.addShapedRecipe(new ResourceLocation("theworlditems2:basalthoerecipe"), new ResourceLocation("custom"), recStack, recipe);
    }
}
