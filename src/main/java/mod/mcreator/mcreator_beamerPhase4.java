...
public class mcreator_beamerPhase4 extends theworlditems2.ModElement {
    @Override
    public void generateSurface(World world, Random random, int i2, int k2) {
        if (random.nextInt(1000000) + 1 <= 50) {
            ...
            Template template = ((WorldServer)world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(), new ResourceLocation("theworlditems2", "beamer_phase_4"));
            if (template == null) {
                return;
            }
