...
public class mcreator_cmdChangeDimension extends theworlditems2.ModElement {
    @Override
    ...
    implements ICommand {
        ...
        public void execute(MinecraftServer server, ICommandSender sender, String[] cmd) {
            ...
            if (entity != null) {
                ...
                mcreator_cmdSwitchDimensionProcedure.executeProcedure($_dependencies);
            }
        }
    }
}
