...
public class mcreator_basaltPickaxeRecipe extends theworlditems2.ModElement {
    @Override
    public void load(FMLInitializationEvent event) {
        ...
        GameRegistry.addShapedRecipe(new ResourceLocation("theworlditems2:basaltpickaxerecipe"), new ResourceLocation("custom"), recStack, recipe);
    }
}
